...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'so.hero.subtitle': 'Unlock lifetime VIP fee discounts on the world\'s top crypto exchanges. Verified partner links — your savings start instantly.',
  ...
  vi: {
    ...
    'so.hero.subtitle': 'Mở khóa giảm giá phí VIP trọn đời trên các sàn giao dịch web3 hàng đầu. Liên kết đối tác đã xác minh — bắt đầu tiết kiệm ngay.',
